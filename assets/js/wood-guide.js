...
function createWoodElement(wood, index) {
    ...
    woodItem.innerHTML = `
        <div class="wood-item__image">
            <img src="data:image/svg+xml;base64,PHN2ZyB3aWR0aD0iNDAwIiBoZWlnaHQ9IjI1MCIgeG1sbnM9Imh0dHA6Ly93d3cudzMub3JnLzIwMDAvc3ZnIj48cmVjdCB3aWR0aD0iMTAwJSIgaGVpZ2h0PSIxMDAlIiBmaWxsPSIjZjhmOGY4Ii8+PC9zdmc+" 
                 data-src="${wood.image}" 
                 alt="${wood.name}" 
                 loading="lazy">
